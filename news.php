<?php
	...
	// 类别 0 1
	if(isset($_POST['classify']) && $_POST['classify']!=""){
		$option = $_POST['classify'];
	}else{
		$valid = false;
		$message = '类别不能为空';
	}
	...
	if($valid){
		$sql = "INSERT INTO  new(title,classify,info,img,artTime,article)VALUES ('$title','$option','$info','$new_file','$registerTime','$txt')";
